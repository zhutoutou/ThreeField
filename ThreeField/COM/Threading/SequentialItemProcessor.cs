...
namespace ZIT.Threading
{
    ...
    public class SequentialItemProcessor<TItem>
    {
        ...
        private Thread _currentProcessTask;
        ...
        public void EnqueueMessage(TItem item)
        {
            ...
            lock (_syncObj)
            {
                ...
                if (!_isProcessing)
                {
                    _currentProcessTask = new Thread(new ThreadStart(ProcessItem));
                    _currentProcessTask.Start();
